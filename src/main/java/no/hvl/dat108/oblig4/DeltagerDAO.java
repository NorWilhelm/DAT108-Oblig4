...
public class DeltagerDAO {
	...
	public List<Deltager> finnAlleDeltagere() {
		List<Deltager> deltagere = em.createQuery("SELECT deltager FROM Deltager deltager ORDER BY " + "deltager.fornavn, deltager.etternavn", Deltager.class).getResultList();
		return deltagere;
	}
